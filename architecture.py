...
class DoubleConv(nn.Module):
    ...
    # requires number of input and output channels

    def __init__(self, in_chan, out_chan):
        super().__init__()  # super(DoubleConv, self).__init__() is the old convention
...
class DownLayer(nn.Module):
    ...
    def __init__(self, in_chan, out_chan):
        ...
        self.pool = nn.MaxPool2d(2)  #nn.MaxPool2d(kernel_size=2, stride=2)
