...
''' MRI dataset with with T1 images and corresponding DW images.'''
...
normalize = tio.Compose([
    ...
    tio.RescaleIntensity(out_min_max=(-1, 1), percentiles=(0, 99))  # rescale output between 0-1 and avoid outliers
])
